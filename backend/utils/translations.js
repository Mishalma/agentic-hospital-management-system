...
const translations = {
  en: {
    ...
    complaintTypeQuestion: "What type of complaint would you like to submit?",
    selectComplaintCategory: "Please select the category that best describes your concern:",
    categorySelected: "Category Selected",
    category: "Category",
    complaintTitlePrompt: "Please provide a brief title for your complaint:",
    titleExample: "Example: \"Long waiting time for appointment\" or \"Billing error on invoice\"",
    titleReceived: "Title Received",
    title: "Title",
    complaintDescriptionPrompt: "Now, please provide a detailed description of your complaint:",
    descriptionTips: "Please include:",
    whatHappened: "What happened?",
    whenDidItHappen: "When did it happen?",
    whoWasInvolved: "Who was involved?",
    howDidItAffectYou: "How did it affect you?",
    titleTooShort: "Please provide a more descriptive title (at least 5 characters).",
    descriptionTooShort: "Please provide a more detailed description (at least 20 characters).",
    complaintSummary: "Complaint Summary",
    description: "Description",
    aiAnalysis: "AI Analysis",
    urgency: "Urgency",
    confidence: "Confidence",
    confirmSubmission: "Would you like to submit this complaint?",
    complaintSubmitted: "Your complaint has been submitted successfully!",
    complaintDetails: "Complaint Details",
    submitted: "Submitted",
    nextSteps: "Next Steps",
    responseTime: "Response within 24 hours",
    updateNotifications: "Updates via Telegram",
    saveComplaintId: "Save your complaint ID",
    contactSupport: "Call support if urgent",
    urgentMatters: "For urgent matters",
    thankYou: "Thank you for your feedback!",
    complaintCancelled: "Complaint Cancelled",
    complaintNotSubmitted: "Your complaint was not submitted.",
    canSubmitLater: "You can submit a complaint anytime by typing /complaint",
    complaintSubmissionError: "Sorry, there was an error submitting your complaint. Please try again or contact support.",
    useButtonsToConfirm: "Please use the buttons above to confirm or cancel your complaint submission.",
  ...
  ml: { // Malayalam
    ...
    complaintTypeQuestion: "നിങ്ങൾ ഏത് തരത്തിലുള്ള പരാതിയാണ് സമർപ്പിക്കാൻ ആഗ്രഹിക്കുന്നത്?",
    selectComplaintCategory: "നിങ്ങളുടെ ആശങ്കയെ ഏറ്റവും നന്നായി വിവരിക്കുന്ന വിഭാഗം തിരഞ്ഞെടുക്കുക:",
    categorySelected: "വിഭാഗം തിരഞ്ഞെടുത്തു",
    category: "വിഭാഗം",
    complaintTitlePrompt: "നിങ്ങളുടെ പരാതിക്ക് ഒരു ചെറിയ ശീർഷകം നൽകുക:",
    titleExample: "ഉദാഹരണം: \"അപ്പോയിന്റ്മെന്റിനുള്ള നീണ്ട കാത്തിരിപ്പ്\" അല്ലെങ്കിൽ \"ബില്ലിലെ പിശക്\"",
    titleReceived: "ശീർഷകം ലഭിച്ചു",
    title: "ശീർഷകം",
    complaintDescriptionPrompt: "ഇപ്പോൾ, നിങ്ങളുടെ പരാതിയുടെ വിശദമായ വിവരണം നൽകുക:",
    descriptionTips: "ദയവായി ഉൾപ്പെടുത്തുക:",
    whatHappened: "എന്താണ് സംഭവിച്ചത്?",
    whenDidItHappen: "എപ്പോഴാണ് ഇത് സംഭവിച്ചത്?",
    whoWasInvolved: "ആരൊക്കെയാണ് ഉൾപ്പെട്ടിരുന്നത്?",
    howDidItAffectYou: "ഇത് നിങ്ങളെ എങ്ങനെ ബാധിച്ചു?",
    titleTooShort: "കൂടുതൽ വിവരണാത്മകമായ ശീർഷകം നൽകുക (കുറഞ്ഞത് 5 അക്ഷരങ്ങൾ).",
    descriptionTooShort: "കൂടുതൽ വിശദമായ വിവരണം നൽകുക (കുറഞ്ഞത് 20 അക്ഷരങ്ങൾ).",
    complaintSummary: "പരാതി സംഗ്രഹം",
    description: "വിവരണം",
    aiAnalysis: "AI വിശകലനം",
    urgency: "അടിയന്തിരത",
    confidence: "ആത്മവിശ്വാസം",
    confirmSubmission: "ഈ പരാതി സമർപ്പിക്കാൻ ആഗ്രഹിക്കുന്നുണ്ടോ?",
    complaintSubmitted: "നിങ്ങളുടെ പരാതി വിജയകരമായി സമർപ്പിച്ചു!",
    complaintDetails: "പരാതി വിവരങ്ങൾ",
    submitted: "സമർപ്പിച്ചത്",
    nextSteps: "അടുത്ത ഘട്ടങ്ങൾ",
    responseTime: "24 മണിക്കൂറിനുള്ളിൽ പ്രതികരണം",
    updateNotifications: "ടെലിഗ്രാം വഴി അപ്ഡേറ്റുകൾ",
    saveComplaintId: "നിങ്ങളുടെ പരാതി ID സേവ് ചെയ്യുക",
    contactSupport: "അടിയന്തിരമാണെങ്കിൽ സപ്പോർട്ടിനെ വിളിക്കുക",
    urgentMatters: "അടിയന്തിര കാര്യങ്ങൾക്ക്",
    thankYou: "നിങ്ങളുടെ ഫീഡ്ബാക്കിന് നന്ദി!",
    complaintCancelled: "പരാതി റദ്ദാക്കി",
    complaintNotSubmitted: "നിങ്ങളുടെ പരാതി സമർപ്പിച്ചില്ല.",
    canSubmitLater: "/complaint ടൈപ്പ് ചെയ്ത് എപ്പോൾ വേണമെങ്കിലും പരാതി സമർപ്പിക്കാം",
    complaintSubmissionError: "ക്ഷമിക്കണം, നിങ്ങളുടെ പരാതി സമർപ്പിക്കുന്നതിൽ പിശകുണ്ടായി. വീണ്ടും ശ്രമിക്കുക അല്ലെങ്കിൽ സപ്പോർട്ടിനെ ബന്ധപ്പെടുക.",
    useButtonsToConfirm: "നിങ്ങളുടെ പരാതി സമർപ്പണം സ്ഥിരീകരിക്കാനോ റദ്ദാക്കാനോ മുകളിലുള്ള ബട്ടണുകൾ ഉപയോഗിക്കുക.",
