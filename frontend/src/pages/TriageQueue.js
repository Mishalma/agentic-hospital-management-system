...
const TriageQueue = () => {
    ...
    const getStatusColor = (status) => {
        switch (status) {
            ...
            case 'in-assessment': return '#17a2b8';
            case 'waiting-doctor': return '#fd7e14';
    ...
    const filteredQueue = selectedPriority === 'all' 
        ? triageQueue 
        : triageQueue.filter(t => t.priority === selectedPriority);
            ...
            <div className="queue-container">
                {filteredQueue.length > 0 ? (
                        ...
                        {filteredQueue.map((triage, index) => (
                            <div key={triage.id} className="triage-card">
                                <div className="card-header">
                                    ...
                                    <div className="priority-info">
                                        <div 
                                            ...
                                            style={{ backgroundColor: getPriorityColor(triage.priority) }}
                                        >
                                ...
                                <div className="card-content">
                                    <div className="triage-details">
                                        ...
                                        <div className="detail-item">
                                            ...
                                            <span 
                                                ...
                                                style={{ backgroundColor: getStatusColor(triage.status) }}
                                            >
                                    ...
                                    {triage.vitals && Object.keys(triage.vitals).some(key => 
                                        triage.vitals[key] && 
                                        (typeof triage.vitals[key] === 'number' || 
                                         (typeof triage.vitals[key] === 'object' && 
                                          Object.values(triage.vitals[key]).some(v => v)))
                                    ) && (
                                        <div className="vitals-section">
                                            ...
                                            <div className="vitals-grid">
                                                {triage.vitals.bloodPressure && 
                                                 (triage.vitals.bloodPressure.systolic || triage.vitals.bloodPressure.diastolic) && (
                                                    <div className="vital-item">
                                                        <label>BP:</label>
                                                        <span>{triage.vitals.bloodPressure.systolic}/{triage.vitals.bloodPressure.diastolic} mmHg</span>
                                                    </div>
                                                )}
                                                ...
                                                {triage.vitals.temperature && triage.vitals.temperature.value && (
                                                    <div className="vital-item">
                                                        <label>Temp:</label>
                                                        <span>{triage.vitals.temperature.value}°{triage.vitals.temperature.unit}</span>
                                                    </div>
                                                )}
                    ...
                    <div className="empty-queue">
                        ...
                        <button 
                            onClick={() => window.location.href = '/triage-assessment'}
