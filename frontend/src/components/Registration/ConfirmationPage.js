    ...
    <Box sx={{ textAlign: 'center' }}>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                  ...
                  <Typography variant="body1">
                    {moment(appointment.slot).format('MMMM DD, YYYY at HH:mm')}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="subtitle2" color="text.secondary">
      ...
      <Alert severity="info" sx={{ mb: 3, textAlign: 'left' }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 20 }}>
          ...
          <li>Show your QR code or mention token number: <strong>{appointment.token}</strong></li>
      ...
      <Card sx={{ mt: 4, backgroundColor: 'grey.50' }}>
        <CardContent>
          ...
          <Typography variant="body2" sx={{ mt: 1 }}>
            ...
            📧 Email: appointments@healthtech.com<br />
